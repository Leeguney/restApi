...
//		registry.addResourceHandler("/**").addResourceLocations("classpath:/templates/html/");
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                ...
                .allowedOrigins("chrome-extension://ilaafkabnbkdgaieedckdnfkmapocimc")	//구글 확장 프로그램 로컬
                .allowedOrigins("chrome-extension://chjbcemdkiommdpeklplkbfpemefejcp")	//구글 확장 프로그램 운영
